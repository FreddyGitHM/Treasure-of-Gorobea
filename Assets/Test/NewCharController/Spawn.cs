...
public class Spawn : MonoBehaviourPunCallbacks, IPunOwnershipCallbacks
{ 
    ...
    void Start()
    {
        ...
        if (PhotonNetwork.IsMasterClient)
        {
            ...
            foreach (Player p in PhotonNetwork.PlayerList)
            {
                ...
                Vector3 spawnPos = new Vector3(Random.Range(2f, 10f), 1f, Random.Range(2f, 10f));
